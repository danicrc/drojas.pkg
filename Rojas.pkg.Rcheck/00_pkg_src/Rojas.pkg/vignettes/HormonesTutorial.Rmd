...
The third function is used to make a linear model statistical analysis. This function is called Linear_model in order to work you must have numerical data in your data set. If you have character data after you run the function you will have a message "Ziggy". Also, after running the function you should select the predictor (column_2) and the response variable (column_1). Remember to use quotation marks.  
...
Function five is used to plot a graph that allows us to compare the relationship between hormones. This function is called Plot_two. In order for the function to work both columns should be numerical. If you include characteristic data this function will be printing the word "turtle". This function will show the relationship  between two hormone concentrations. 
